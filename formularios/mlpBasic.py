...
def guardar_modelo():
    ...
    if 'model' in globals():
        ...
        nuevo_numero = 0
        while os.path.exists(f"modelosMLPB/modelo_{nuevo_numero:02}.h5"):
            nuevo_numero += 1
        ...
        log_file_path = os.path.join('modelosMLPB', 'log.xlsx')
        ...
        nuevo_path = os.path.join('modelosMLPB', nuevo_nombre)
...
root = tk.Tk()
root.title("Formulario de MLP Básica")
